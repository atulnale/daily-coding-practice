...
public class Printing3D {
    public static void main(String[] args) {
        ...
        while(step <= t) {
            ...
            System.out.print("Case #"+step+": " );
            long res = (long)C.peek() + M.peek() + Y.peek() + K.peek() ;
            long quantity = 1000000;
            if(res < quantity) System.out.printf("IMPOSSIBLE");
            else {
                ...
                for(int i = 0; i< ans.size(); i++) {
                    if(filled) System.out.print(0+ " ");
                    else {
                        if(sum + ans.get(i) > quantity) {
